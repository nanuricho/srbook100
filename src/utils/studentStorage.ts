...
export const ALL_SAMPLE_STUDENT_IDS = new Set([
  's_1_1_1_김하람', 's_1_1_2_이서준', 's_1_2_1_박예은',
  's_2_1_1_최유진', 's_2_1_2_정민호', 's_2_2_1_한소율',
  's_3_1_1_김민준', 's_3_1_2_이서아', 's_3_1_3_박도윤', 's_3_1_4_최지우', 's_3_1_5_정예준', 's_3_2_1_강하은', 's_3_2_2_윤시우',
  's_4_1_1_신서연', 's_4_1_2_오준우', 's_4_2_1_문지아',
  's_5_1_1_배승우', 's_5_1_2_류하린', 's_5_2_1_송우진',
  's_6_1_1_홍시은', 's_6_1_2_조태현', 's_6_2_1_임서진',
]);
...
export function loadStudentsFromStorage(): Student[] {
  try {
    ...
    if (Array.isArray(parsed)) {
      // Only keep authentic user-entered students, removing any mock/sample students
      const cleanStudents = parsed.filter((s) => !ALL_SAMPLE_STUDENT_IDS.has(s.id));
      if (cleanStudents.length !== parsed.length) {
        saveStudentsToStorage(cleanStudents);
      }
